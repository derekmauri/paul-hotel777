...
@section('judul', 'Tambah Data Daftar Kamar')
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Form Tambah Data Daftar Kamar</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('daftarKamar.store') }}" method="POST" enctype="multipart/form-data"
                                    novalidate>
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                                ...
                                                <div class="controls">
                                                    <select name="tipe_id" required class="form-select">
                                                        ...
                                                        @foreach ($tipe as $item)
                                                            <option value="{{ $item->id }}">{{ $item->tipe_kamar }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
