...
@section('judul', 'Data Daftar Kamar')
        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="clearfix">
                        <a href="{{ route('daftarKamar.create') }}"><button type="button"
