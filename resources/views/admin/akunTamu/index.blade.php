        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="clearfix">
                        <a href="{{ route('akunTamu.create') }}"><button type="button"
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($akunTamu as $item)
                                                <tr>
                                                    <td align="center">{{ $loop->iteration }}</td>
                                                    <td>{{ $item->tamu->nm_tamu }}</td>
                                                    <td>{{ $item->user->email }}</td>
                                                    <td>{{ $item->user->show_password }}</td>
                                                    <td align="center">
                                                        <a href="{{ route('akunTamu.edit', $item->id) }}"><button
                                                                type="submit"
                                                                class="waves-effect waves-light btn btn-outline btn-success mb-5"><i
                                                                    class="fa fa-edit (alias)"></i> Edit</button></a>
                                                        <form action="{{ route('akunTamu.destroy', $item->id) }}"
