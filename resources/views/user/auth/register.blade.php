...
<head>
  <meta charset="utf-8">
	...
	<!-- Style-->
	<link rel="stylesheet" href="asset_admin/css/horizontal-menu.css">
...
<body class="hold-transition theme-primary bg-img" style="background-image: url('images/login.jpg')">
	...
	<!-- Vendor JS -->
	<script src="asset_admin/js/vendors.min.js"></script>
	<script src="asset_admin/js/pages/chat-popup.js"></script>
    <script src="asset_admin/assets/icons/feather-icons/feather.min.js"></script>
