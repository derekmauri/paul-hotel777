...
<nav class="main-nav" role="navigation">
    ...
    <ul id="main-menu" class="sm sm-blue">
        ...
        <li><a href="karyawan-user"><i class="fa fa-photo"><span class="path1"></span><span
                        class="path2"></span></i>KARYAWAN</a></li>
        <li><a href="fasilitas-user"><i class="fa fa-photo"><span class="path1"></span><span
                        class="path2"></span></i>FASILITAS KAMAR</a></li>
        <li><a href="tipe-user"><i class="fa fa-photo"><span class="path1"></span><span
                        class="path2"></span></i>TIPE KAMAR</a></li>
