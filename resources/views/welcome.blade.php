...
<head>
    ...
    <!-- Vendors Style-->
    <link rel="stylesheet" href="{{ asset('asset_admin/css/vendors_css.css') }}">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="example6" class="display table table-bordered table-separated"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="row-6-position"
                                                            name="row-6-position" value="Integration Specialist"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="row-8-position"
                                                            name="row-8-position" value="Integration Specialist"></td>
    ...
    <script src="{{ asset('asset_admin/js/pages/data-table.j') }}"></script>
